  ...
  return (
    <div 
      ...
      className={`w-72 sm:w-80 rounded-[2rem] p-2 relative flex flex-col items-center hover:scale-[1.02] transition-all duration-700 z-10 ${className} ${
        isActive ? 'bg-[#10b981] border-emerald-400 shadow-[0_20px_50px_rgba(16,185,129,0.4)]' : 'bg-white border border-gray-200 shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)]'
      }`}
    >
      {/* The hole punch */}
      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="Define"
            text="Analyzing system requirements, database schema structures (MongoDB, MySQL), and API integration paths (such as payment gateways and third-party tools)."
          ...
          <TagCard 
            number="02"
            title="Design"
            text="Architecting clean, state-managed frontend interfaces with React & Redux and mapping complex automation pipelines with n8n nodes."
          ...
          <TagCard 
            number="03"
            title="Build"
            text="Developing high-performance RESTful APIs in Node.js/Express, responsive interfaces in React, and integrating automated background tasks."
          ...
          <TagCard 
            number="04"
            title="Launch"
            text="Deploying applications securely to cloud infrastructure (AWS), running load testing, and optimizing queries to reduce response times by 40%."
