    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#10b981] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-emerald-900/30">
              Aditya<span className="text-emerald-900/30">.</span>
            </div>
            ...
            >
              Aditya<span className="text-black">.</span>
            </motion.div>
          </motion.div>
